...
@everywhere begin
    ...
    vars = matread("../dataset/FashionMNIST_1_2.mat")
    ...
    function f(i_::Int64)
        ...
        position_x = Int64[i for i in 1:270]
        position_theta = Int64[i for i in 271:540]
        ...
        matwrite("CODE/circuit_encoding/benchmark/FashionMNIST_BE_EncodingFirst_20220208_"*string(i_)*".mat", Dict(
